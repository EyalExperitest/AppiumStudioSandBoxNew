...
public class SA19132 {
    private String reportDirectory = "reports";
    private String reportFormat = "xml";
    private String testName = "SA19132";
    ...
    @Test
    public void testSA19132() {
        driver.context("NATIVE_APP");
        //Object result1 = driver.executeScript("client:client.startMonitor(\"com.experitest.ExperiBank\");");
        driver.executeScript("experitest:client.startMonitor('cpu:com.experitest.ExperiBank')");

        Object result2 = driver.executeScript("client:client.setMonitorPollingInterval(300);");
