...
public class IOSNonInstrumentedClick {
    private String reportDirectory = "reports";
    private String reportFormat = "xml";
    private String testName = "IOS Non Instrumented Click";
...
//            driver.findElement(By.xpath("//*[@XCElementType='XCUIElementTypePageIndicator']")).click();
            driver.findElement(By.xpath("//*[@text and @class='UIAView' and ./parent::*[@class='UIAView' and ./parent::*[@class='UIAScrollView']]]")).click();
